      ...
      <PageScaffold title="Interview Prep" subtitle="Practice role-specific answers with structured examples">
        ...
        <section className="grid gap-4 xl:grid-cols-[1.35fr_0.65fr]">
          <Card>
            ...
            <div className="grid gap-3">{questions.map(question => <div key={question} className="rounded-md border border-border bg-elevated p-4 text-sm text-[var(--text-secondary)]">{question}</div>)}</div>
          </Card>
          <Card>
