    ...
    <div style={{ minHeight: '100dvh', background: 'var(--bg)', padding: '24px 20px 60px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        {[
          ...
          { title: '5. Service availability', body: 'FitScore is provided "as is" without warranty. We do our best to maintain uptime but cannot guarantee uninterrupted service. We reserve the right to modify or discontinue features at any time.' },
          ...
          { title: '8. Liability limitation', body: 'To the fullest extent permitted by law, FitScore is not liable for any indirect, incidental, or consequential damages arising from use of the service, including missed job opportunities or rejected applications.' },
