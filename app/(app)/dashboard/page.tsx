      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1fr_22rem]">
        <Card>
          ...
          <div className="grid gap-3">
            <ProgressRow label="Applied" value={85} />
            <ProgressRow label="Screening" value={32} tone="violet" />
            <ProgressRow label="Interview" value={26} tone="emerald" />
            <ProgressRow label="Assessment" value={11} tone="amber" />
            <ProgressRow label="Rejected" value={18} tone="red" />
          </div>
        </Card>
        <Card>
          <CardHeader><CardTitle>Latest ATS score</CardTitle></CardHeader>
          <div className="grid gap-3">
        ...
        <Card>
          ...
          <div className="grid gap-3 text-sm text-[var(--text-secondary)]">
            {['Summit Paris · Interview', 'Capgemini · Applied', 'BNP Paribas · Offer'].map(item => <p key={item}>{item}</p>)}
          </div>
        </Card>
      </section>
    </PageScaffold>
